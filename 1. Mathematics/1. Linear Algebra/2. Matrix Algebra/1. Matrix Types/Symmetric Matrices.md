...
> A **symmetric matrix** is a square matrix that is equal to its own [[Properties of Transpose and Inverse|transpose]]. This simple, elegant property leads to some of the most important and well-behaved results in linear algebra. Symmetric matrices are guaranteed to have real [[Eigenvalues and Eigenvectors|eigenvalues]], an [[Orthonormal Basis]] of [[Eigenvalues and Eigenvectors|eigenvectors]], and are always [[Diagonalization of a Matrix|diagonalizable]]. They are central to many applications, including quadratic forms, mechanics, and stability analysis.
