...
> The **Adjoint** (or Adjugate) of a square matrix $A$, denoted as $\text{adj}(A)$, is the **[[Properties of Transpose and Inverse|Transpose]] of the [[Minors and Cofactors|Cofactor Matrix]]** of $A$. It provides a direct algebraic method to compute the inverse of a matrix without using Gaussian elimination.
