...
> A **saddle point** is a type of [[Maxima and Minima (Multivariable)#Critical Points (First Derivative Test)|critical point]] of a multivariable function that is neither a local maximum nor a local minimum. It represents a point where the function's slope is zero, but the function increases in some directions and decreases in others.
...
The definitive way to classify a critical point $(a,b)$ as a saddle point is by using the [[Maxima and Minima (Multivariable)#The Second Derivative Test|second derivative test]].
