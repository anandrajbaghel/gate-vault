...
> [!prerequisite]
> [[By-Parts Integration]] (many questions often requires by-parts integration)
...
> 3.  **Calculate I.F.**: $$\text{I.F.} = e^{\int (2/x)dx} = e^{2\ln x} = e^{\ln(x^2)} = x^2$$
> 4.  **Apply Formula**: $$ y \cdot x^2 = \int (x \cdot x^2) \, dx + C $$
> 5.  **Integrate**: $$ y x^2 = \int x^3 \, dx + C = \frac{x^4}{4} + C $$
> 6.  **Solve for y**: $$ y = \frac{x^2}{4} + \frac{C}{x^2} $$
> 7.  **Apply Initial Condition** ($y(1)=1$): $$ 1 = \frac{1^2}{4} + \frac{C}{1^2} \implies 1 = \frac{1}{4} + C \implies C = \frac{3}{4} $$ The particular solution is $y = \frac{x^2}{4} + \frac{3}{4x^2}$.
